...
#!perl
#line 29
    eval 'exec D:\programowanie\Strony\Projekty\programy\xammp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'D:\programowanie\Strony\Projekty\programy\xammp\perl\bin\perl.exe';
